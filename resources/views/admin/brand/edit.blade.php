                        ...
                        <div class="ibox-content">
                            <form id="form"  method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" value="{{$data->brand_url}}" name="brand_url" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">是否显示</label>
                                    <div class="col-sm-5">
                                        <input type="radio" name="brand_show" value="1" {{($data->brand_show)==1 ? 'checked' : ''}}>是
                                        <input type="radio" name="brand_show" value="2" {{($data->brand_show)==2 ? 'checked' : ''}}>否
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <img src="{{env('APP_URL')}}app/{{$data->brand_img}}" id="img"  width="100px" height="100px" alt="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 col-sm-offset-2">
                                        <button class="btn btn-primary" id="upd" type="button">添加</button>
                                    </div>
                                </div>
                            </form>
